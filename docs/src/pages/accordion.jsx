  ...
  return (
    <>
      ...
      <Section title="Пример">
        <Meta>
          По умолчанию открыта одна панель. Несколько сразу:{' '}
          <code>data-multi-expand="true"</code> на корне.
        </Meta>
        <Demo>
...
<!-- несколько открытых: data-multi-expand="true" -->`}
      ...
      <Section title="Идеи расширения">
        <ul>
          ...
          <li>
            <code>data-multi-expand="true"</code> для независимых секций; по умолчанию — одна
            открытая, как в FAQ.
          </li>
          <li>
            Якорь на <code>id</code> у <code>details</code> — deep-link на конкретный вопрос без
            JS.
          </li>
        </ul>
      </Section>
